KemperMIDI {
    ...
    *new { |device, port, chan = 1|
    ...
    fxType { |addrPg, fxKey, switchOn = true|
        var page = this.prPageCheck( addrPg );        
    ...
    *initClass {
        var fxAddr = (
            ...
            modulationRatePhaser:        20,
            modulationRatePhaserVibe:    20,
            modulationRateFlanger:       20,
            autoSwell:                   20,
            widenerTune:                 20,
            driveDefinition:             21,
        ...
        addrNrKeys = (
            ...
            systemGlobal: (
                ...
                directOutVolume:     3,
                send1Volume:         3,
                SPDIFVolume:         4, // find a consistent key for this one...
                monitorCabOff:       8,
                mainEQBass:          12,
                mainEQMiddle:        13,
                mainEQTreble:        14,
